/**
 * Miscurin Design Tokens
 *
 * Single source of truth for all design decisions.
 * These mirror the values in tailwind.config.ts and are the
 * canonical reference for any non-Tailwind styling (e.g. inline styles,
 * canvas, PDFs, email templates).
 */
